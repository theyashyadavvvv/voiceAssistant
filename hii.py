...
def start(query):
    if 'wikipedia' in query.lower():
        ...
        speak("Hiii  !  I am yash created by yash  on 19th of march 2023 !!  I am a python assistant ....ready to help you with your queries....")

    elif 'what do you do' in query.lower() or 'how can you help' in query.lower() or 'more about you' in query.lower():
        speak("yash can help you to automate your tasks such as search videos in YouTube and play them, send emails, open websites, search materials in Wikipedia and read them,inform weather forecast in your country,jell jokes,  greetings and more. ")
    elif 'hi' in query.lower():
        speak("Hii yash, glad to talk to you!")
    ...
    elif 'bye yash' in query.lower() or 'thanks bye' in query.lower() or 'goodbye' in query.lower() or 'good bye' in query.lower() or 'bye' in query.lower() :
